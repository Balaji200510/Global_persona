...
export default function ContactDetailsPage() {
    ...
    const summaryCards = [
        { label: 'Active', value: currentList.contactCount, icon: CheckCircle2, color: 'green', bgColor: 'bg-green-50', textColor: 'text-green-600' },
        { label: 'Unsubscribed', value: 0, icon: AlertTriangle, color: 'amber', bgColor: 'bg-amber-50', textColor: 'text-amber-600' },
        { label: 'Bounced', value: 0, icon: XCircle, color: 'red', bgColor: 'bg-red-50', textColor: 'text-red-600' },
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                <div className="space-y-2">
                    ...
                    <p className="text-sm text-gray-500">
                        {currentList.description || "View and manage contacts in this list"}
                    </p>
                </div>
